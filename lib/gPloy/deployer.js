...
var spawn = require('./spawner').detached;
            ...
            if(!error) {
                self.findStartScript(workDir, function(error, file) {
                    ...
                    if(typeof file !== "undefined") {
                        ...
                        var pids = pidManager.getAll(appname + "-forever");
                        pids.forEach(function(pid) {
                            ...
                            pidManager.remove(appname + "-forever", pid);
                        });

                        pids = pidManager.getAll(appname);
                        pids.forEach(function(pid) {
                            try {
                                process.kill(pid, 9);
                            } catch (e) {
                            ...
                            pidManager.remove(appname, pid);
                        });

                        spawn(appname + "-forever", 'node', ["helper/forever.js", outLogs, errLogs, workDir, appname, file], {
